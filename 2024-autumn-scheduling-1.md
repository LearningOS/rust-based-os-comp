...
- [参加往届 OS 训练营学生的 Blog](https://rcore-os.github.io/blog/)，鼓励参加2024 OS训练营的同学把自己在学习过程中的感悟/收获等写成blog，生成pr，并提交到 <https://github.com/rcore-os/blog> 上，让更多人看到你的进步！
...
- **注意** 第一阶段学习中的技术问题，建议基于[训练营讨论版](https://github.com/LearningOS/rust-based-os-comp2023/discussions) 发出并讨论。
